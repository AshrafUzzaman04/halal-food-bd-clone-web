...
<section class="pro_detls mt-5">
    <div class="container-lg">
        <div class="details row">
            <div class="pro col-12 col-sm-10  col-md-6 ">
                <div class="img_pro">
            ...
            <div class="pro_order mt-4 mt-md-0 col-12 col-sm-8 col-md-6">
                ...
                <div class="button_div d-flex">
                    <button class="tt d-inline m-0 me-2 border-1 rounded px-2 my-2 py-1 d-flex justify-content-center align-items-center bg-transparent" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="1 Kg">
                        1 KG
                    </button>
                ...
                <small class="fw-bold text-success d-block my-2">99496 in stock</small>
                <form class="d-block quantity_input">
                ...
                <button class="d-block button_buy my-3">Buy Now</button>
                <button class="d-block bg-dark border-0 text-white px-3 py-1 my-4 continue_shopping">Continue Shopping</button>
                <hr>
                <span class="text-dark fw-light" style="font-size: 15px;">SKU: 02-Regular-02</span>
                <hr>
                <span class="text-dark fw-light" style="font-size: 15px;">Category: Foods</span>
                <div class="social_icons my-3">
                    <!-- Facebook -->
                    <a class="btn" href="#!" role="button"><i class="fab fa-facebook-f"></i></a>
                    ...
                    <!-- Linkedin -->
                    <a class="btn" href="#!" role="button"><i class="fab fa-linkedin-in"></i></a>

                    <!-- Pinterest -->
                    <a class="btn" href="#!" role="button"><i class="fab fa-pinterest"></i></a>

                    <!-- Whatsapp -->
                    <!-- <a class="btn" href="#!" role="button"><i class="fab fa-whatsapp"></i></a> -->
        ...
        <div class="tab_contents">
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active pb-3" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                    <p>
                        ✅দীর্ঘ ৮ মাস পর আবারো সরাসরি ইন্ডিয়া থেকে আসছে অরিজিনাল দুলাল চন্দ্র ভড়ের বিখ্যাত তালমিছরি হালাল ফুড সার্ভিসে❤️ বর্তমানে দেশের বাজারেই পাওয়া যাচ্ছে চিটা গুঁড় ও গোখাদ্য এর সমন্বয়ে তৈরি ভেজাল দুলাল চন্দ্র ভড়ের তালমিছরি। তবে আমরা সরাসরি ইন্ডিয়া থেকে বেনাপোল বর্ডারে শুল্ক দিয়ে এবং বাংলাদেশ বিজ্ঞান ও শিল্প গবেষণা পরিষদ ল্যাব টেস্টেড জগৎ বিখ্যাত দুলাল চন্দ্র ভড়ের তালমিছরি পৌঁছে দিচ্ছি।
                    </p>
                    <p>
                        👉৮০ বছরের বেশি সময় ধরে দুলাল চন্দ্র ভড়ের তালমিছরি গুনে মানে সবার সেরা😍 যারা নব্বইয়ের দশকে বেড়ে উঠেছে বাংলায় তারা খুবই পরিচিত দুলালের তালমিছরির সাথে🤗তাল মিছরি হতে পারে আমাদের চিনির বিকল্প, হালুয়া, সেরেলাক বিস্কুট, শরবত, কেক, ইত্যাদি বিভিন্ন মিস্টি খাবারে চিনির পরিবর্তে মিছরি ব্যবহার করতে পারেন।
                    </p>
                </div>

                <!-- ADDITIONAL INFORMATION -->
                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                    <span><strong>WEIGHT: &nbsp;&nbsp;</strong><strong class="fs-5">1 Kg</strong></span>
                </div>
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">ja ase tai dia dimu naki?</div>
            </div>
